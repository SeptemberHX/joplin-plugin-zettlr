...
import { getBlockMathRE, getInlineMathRenderRE } from './regular-expressions'
...
export function markdownRenderMath(cm: CodeMirror.Editor) {
    ...
    for (let myMarker of equations) {
        ...
        console.log('===> Render math', myMarker.eq);
        katex.render(myMarker.eq, mathSpan, { throwOnError: false, displayMode: myMarker.displayMode, output: 'html' })
